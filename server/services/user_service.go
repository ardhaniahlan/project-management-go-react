...
type UserService interface {
	...
	Update(user *models.User, publicID uuid.UUID) error
...
func (s *userService) Update(user *models.User, publicID uuid.UUID) error {
	return s.repo.Update(user, publicID.String())
}
